      ...
      <div class="dropdown">
        ...
        <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
          {#if authStore.isAuthenticated}
            ...
            <li><a href="/workorders" class:active={$page.url.pathname.startsWith('/workorders')}>Work Orders</a></li>
          {/if}
        </ul>
      </div>
    ...
    <div class="navbar-center hidden lg:flex">
      {#if authStore.isAuthenticated}
        <ul class="menu menu-horizontal px-1">
          <li>
            <a href="/" class="font-medium {$page.url.pathname === '/' ? 'active' : ''}">
          ...
          <li>
            <a href="/workorders" class="font-medium {$page.url.pathname.startsWith('/workorders') ? 'active' : ''}">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
